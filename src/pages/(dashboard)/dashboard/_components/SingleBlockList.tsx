...
export default function SingleBlockList({blockList}: Props){
    return (
            <div key={blockList.id}
						...
						<div className="flex items-center gap-4">
							<CustomButton className="bg-blue-500 text-white rounded-full p-3 h-8 w-8" onClick={() => setShowEditDialog({
								type: "edit",
								show: true,
								data: blockList,
							})} variant="text">
