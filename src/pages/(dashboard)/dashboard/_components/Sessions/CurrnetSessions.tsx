...
const CurrentSessions = ({ current_sessions }: Props) => {
	return (
		<div className="relative w-full">
			{current_sessions ?
				<div className="flex flex-col gap-2">{current_sessions.map(session=><div key={session.id} className="rounded-sm cursor-pointer flex justify-between bg-[#29a259] py-2 px-4 last:mb-6">
