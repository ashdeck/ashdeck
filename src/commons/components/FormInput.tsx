...
const FormInput = (props: FormInputProps) => {
	...
	const textFieldClass = `bg-gray-400 text-black dark:text-gray-400 my-2 dark:autofill:bg-gray-900 autofill:bg-gray-500 p-3 ${
		startIcon && "pl-12"
	} ${
		endIcon && "pr-12"
			...
			<div className="my-4 w-full">
				...
				<div className="relative flex w-full items-center">
					...
					/>
					{
						embeddedComponent ? (
							<div
								className={`absolute right-4 flex items-center h-fit w-fit text-gray-400 transition `}>
								{embeddedComponent}
							</div>
						) : (
							<div
		...
		return (
			<div className="relative flex w-full items-center">
				...
				/>
				{
					embeddedComponent ? (
						<div
							className={`absolute right-1.5 flex items-center h-fit w-fit text-gray-400 transition `}>
							{embeddedComponent}
						</div>
					) : (
						<div
